...
public static class BServer
{
    ...
    public static void SetMaxPlayers(ILuaVM vm, long max_players, bool? persist_to_config_file = null)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Server");
    ...
    public static void KickByAccountID(ILuaVM vm, string player_account_id, string reason)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Server");
        vm.GetField(-1, "KickByAccountID");
        pc++;
        vm.PushString(player_account_id);
        pc++;
    ...
    public static void BanByAccountID(ILuaVM vm, string player_account_id, string reason)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Server");
        vm.GetField(-1, "BanByAccountID");
        pc++;
        vm.PushString(player_account_id);
        pc++;
        vm.PushString(reason);
    ...
    public static bool IsPackageLoaded(ILuaVM vm, string package_name)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Server");
        vm.GetField(-1, "IsPackageLoaded");
        pc++;
    ...
    public static long GetPort(ILuaVM vm)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Server");
    ...
    public static long GetQueryPort(ILuaVM vm)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Server");
    ...
    public static long GetCompressionLevel(ILuaVM vm)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Server");
    ...
    public static long GetMaxPlayers(ILuaVM vm)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Server");
    ...
    public static long GetTickRate(ILuaVM vm)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Server");
    ...
    public static long GetTime(ILuaVM vm)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Server");
