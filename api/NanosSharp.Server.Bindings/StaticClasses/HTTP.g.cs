...
public static class BHTTP
{
    ...
    public static void SetConnectionTimeout(ILuaVM vm, long connection_timeout)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "HTTP");
    ...
    public static void SetReadWriteTimeout(ILuaVM vm, long read_write_timeout)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "HTTP");
