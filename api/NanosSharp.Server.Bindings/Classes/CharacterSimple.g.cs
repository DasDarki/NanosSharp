...
public class CharacterSimple : Paintable
{
    ...
    public static void SetMaxAcceleration(ILuaVM vm, LuaRef selfRef, LuaRef acceleration)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "CharacterSimple");
    ...
    public static void SetSpringArmSettings(ILuaVM vm, LuaRef selfRef, LuaRef relative_location, LuaRef target_arm_length, LuaRef socket_offset, bool enable_camera_lag, LuaRef camera_lag_speed)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "CharacterSimple");
        ...
        pc++;
        vm.RawGetI(ILuaVM.RegistryIndex, target_arm_length);
        pc++;
        vm.RawGetI(ILuaVM.RegistryIndex, socket_offset);
        pc++;
        vm.PushBoolean(enable_camera_lag);
        pc++;
        vm.RawGetI(ILuaVM.RegistryIndex, camera_lag_speed);
        vm.MCall(pc, 0);
        vm.ClearStack();
    }
    ...
    public static void SetSpeedSettings(ILuaVM vm, LuaRef selfRef, LuaRef max_walk_speed, LuaRef max_walk_speed_crouched)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "CharacterSimple");
