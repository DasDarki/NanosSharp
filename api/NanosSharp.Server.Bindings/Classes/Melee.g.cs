...
public class BMelee : BEntity
{
    ...
    public static void SetBaseDamage(ILuaVM vm, LuaRef selfRef, long? damage = null)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Melee");
    ...
    public static long GetBaseDamage(ILuaVM vm, LuaRef selfRef)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Melee");
