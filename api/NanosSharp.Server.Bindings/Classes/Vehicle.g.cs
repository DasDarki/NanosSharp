...
public class Vehicle
{
    ...
    public static void SetDoor(ILuaVM vm, LuaRef selfRef, LuaRef seat_index, LuaRef offset_location, LuaRef seat_location, LuaRef seat_rotation, LuaRef trigger_radius, LuaRef leave_lateral_offset)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Vehicle");
    ...
    public static LuaRef GetPassenger(ILuaVM vm, LuaRef selfRef, LuaRef seat)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Vehicle");
