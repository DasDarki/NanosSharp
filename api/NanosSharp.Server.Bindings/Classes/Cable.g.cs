...
public class Cable : Paintable
{
    ...
    public static void SetCableSettings(ILuaVM vm, LuaRef selfRef, LuaRef length, LuaRef num_segments, LuaRef solver_iterations)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Cable");
        ...
        pc++;
        vm.RawGetI(ILuaVM.RegistryIndex, num_segments);
        pc++;
        vm.RawGetI(ILuaVM.RegistryIndex, solver_iterations);
        vm.MCall(pc, 0);
        vm.ClearStack();
    }
    ...
    public static void SetRenderingSettings(ILuaVM vm, LuaRef selfRef, LuaRef width, LuaRef num_sides, LuaRef tile_material)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Cable");
