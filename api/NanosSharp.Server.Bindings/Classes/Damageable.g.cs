...
{
    public static LuaRef ApplyDamage(ILuaVM vm, LuaRef selfRef, LuaRef damage, string? bone_name = null, DamageType? damage_type = null, LuaRef? from_direction = null, LuaRef? instigator = null, object? causer = null)
    {
        int pc = 0;
        vm.PushGlobalTable();
    ...
    public static LuaRef GetHealth(ILuaVM vm, LuaRef selfRef)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Damageable");
    ...
    public static LuaRef GetMaxHealth(ILuaVM vm, LuaRef selfRef)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Damageable");
    ...
    public static void SetHealth(ILuaVM vm, LuaRef selfRef, LuaRef new_health)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Damageable");
    ...
    public static void SetMaxHealth(ILuaVM vm, LuaRef selfRef, LuaRef max_health)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Damageable");
