...
public class BPawn
{
    ...
    public static void SetAIAvoidanceSettings(ILuaVM vm, LuaRef selfRef, bool enabled, long? avoidance_consideration_radius = null)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Pawn");
        vm.GetField(-1, "__function");
        vm.GetField(-1, "SetAIAvoidanceSettings");
        pc++;
        vm.RawGetI(ILuaVM.RegistryIndex, selfRef);
        pc++;
        vm.PushBoolean(enabled);
        if (avoidance_consideration_radius != null)
        {
             pc++;
             vm.RawGetI(ILuaVM.RegistryIndex, avoidance_consideration_radius.Value);
        }
        vm.MCall(pc, 0);
        vm.ClearStack();
    }
    ...
    public static void SetJumpZVelocity(ILuaVM vm, LuaRef selfRef, long jump_z_velocity)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Pawn");
    ...
    public static void SetCapsuleSize(ILuaVM vm, LuaRef selfRef, long radius, long half_height)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Pawn");
    ...
    public struct GetCapsuleSize_Return0
    {
        ...
        public static implicit operator GetCapsuleSize_Return0(Dictionary<string, object> d)
        {
            ...
            {
                Radius = (long)d["Radius"],
                HalfHeight = (long)d["HalfHeight"],
            };
        }
    }
    ...
    public static void SetBrakingSettings(ILuaVM vm, LuaRef selfRef, LuaRef? ground_friction = null, LuaRef? braking_friction_factor = null, long? braking_walking = null, long? braking_flying = null, long? braking_swimming = null, long? braking_falling = null)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Pawn");
