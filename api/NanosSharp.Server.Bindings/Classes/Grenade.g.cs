...
public class BGrenade : BEntity
{
    ...
    public static void SetDamage(ILuaVM vm, LuaRef selfRef, long? base_damage = null, long? minimum_damage = null, long? damage_inner_radius = null, long? damage_outer_radius = null, LuaRef? damage_falloff = null)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Grenade");
    ...
    public static void SetThrowForce(ILuaVM vm, LuaRef selfRef, long throw_force)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Grenade");
