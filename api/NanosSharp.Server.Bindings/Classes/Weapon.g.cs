...
public class Weapon : Pickable
{
    ...
    public static void SetAmmoBag(ILuaVM vm, LuaRef selfRef, LuaRef new_ammo_bag)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Weapon");
    ...
    public static void SetAmmoClip(ILuaVM vm, LuaRef selfRef, LuaRef new_ammo_clip)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Weapon");
    ...
    public static void SetAmmoSettings(ILuaVM vm, LuaRef selfRef, LuaRef ammo_clip, LuaRef ammo_bag, LuaRef? ammo_to_reload = null, LuaRef? clip_capacity = null)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Weapon");
    ...
    public static void SetBulletSettings(ILuaVM vm, LuaRef selfRef, LuaRef bullet_count, LuaRef bullet_max_distance, LuaRef bullet_velocity, LuaRef bullet_color)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Weapon");
    ...
    public static void SetClipCapacity(ILuaVM vm, LuaRef selfRef, LuaRef clip)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Weapon");
    ...
    public static void SetDamage(ILuaVM vm, LuaRef selfRef, LuaRef damage)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Weapon");
    ...
    public static void SetSoundFireLastBullets(ILuaVM vm, LuaRef selfRef, string sound_asset_path, LuaRef? remaining_bullets_count = null)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Weapon");
    ...
    public static void SetWallbangSettings(ILuaVM vm, LuaRef selfRef, LuaRef max_distance, LuaRef damage_multiplier)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Weapon");
    ...
    public static LuaRef GetAmmoBag(ILuaVM vm, LuaRef selfRef)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Weapon");
    ...
    public static LuaRef GetAmmoClip(ILuaVM vm, LuaRef selfRef)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Weapon");
    ...
    public static LuaRef GetAmmoToReload(ILuaVM vm, LuaRef selfRef)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Weapon");
    ...
    public static LuaRef GetBulletCount(ILuaVM vm, LuaRef selfRef)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Weapon");
    ...
    public static LuaRef GetClipCapacity(ILuaVM vm, LuaRef selfRef)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Weapon");
    ...
    public static LuaRef GetDamage(ILuaVM vm, LuaRef selfRef)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Weapon");
