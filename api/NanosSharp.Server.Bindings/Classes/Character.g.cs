...
public class Character : Paintable
{
    ...
    public static void EnterVehicle(ILuaVM vm, LuaRef selfRef, LuaRef vehicle, LuaRef? seat = null)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Character");
    ...
    public static void SetAccelerationSettings(ILuaVM vm, LuaRef selfRef, LuaRef? walking = null, LuaRef? parachuting = null, LuaRef? skydiving = null, LuaRef? falling = null, LuaRef? swimming = null, LuaRef? swimming_surface = null, LuaRef? flying = null)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Character");
    ...
    public static void SetFallDamageTaken(ILuaVM vm, LuaRef selfRef, LuaRef damage)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Character");
    ...
    public static void SetGravityScale(ILuaVM vm, LuaRef selfRef, LuaRef gravity_scale)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Character");
        ...
        vm.RawGetI(ILuaVM.RegistryIndex, selfRef);
        pc++;
        vm.RawGetI(ILuaVM.RegistryIndex, gravity_scale);
        vm.MCall(pc, 0);
        vm.ClearStack();
    }

    public static void SetImpactDamageTaken(ILuaVM vm, LuaRef selfRef, LuaRef impact_damage)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Character");
    ...
    public static void SetRadialDamageToRagdoll(ILuaVM vm, LuaRef selfRef, LuaRef damage)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Character");
    ...
    public static void SetPunchDamage(ILuaVM vm, LuaRef selfRef, LuaRef punch_damage)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Character");
    ...
    public static void SetTeam(ILuaVM vm, LuaRef selfRef, LuaRef team)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Character");
    ...
    {
        public LuaRef Radius;
        public LuaRef HalfHeight;
        public static implicit operator GetCapsuleSize_Return0(Dictionary<string, object> d)
        {
            return new GetCapsuleSize_Return0
            {
                Radius = (LuaRef)d["Radius"],
                HalfHeight = (LuaRef)d["HalfHeight"],
            };
        }
    }

    public static GetCapsuleSize_Return0 GetCapsuleSize(ILuaVM vm, LuaRef selfRef)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Character");
    ...
    public static LuaRef GetFallDamageTaken(ILuaVM vm, LuaRef selfRef)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Character");
    ...
    public static LuaRef GetGravityScale(ILuaVM vm, LuaRef selfRef)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Character");
    ...
    public static LuaRef GetImpactDamageTaken(ILuaVM vm, LuaRef selfRef)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Character");
    ...
    public static LuaRef GetJumpZVelocity(ILuaVM vm, LuaRef selfRef)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Character");
    ...
    public static LuaRef GetPunchDamage(ILuaVM vm, LuaRef selfRef)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Character");
    ...
    public static LuaRef GetTeam(ILuaVM vm, LuaRef selfRef)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Character");
    ...
    public static LuaRef GetVehicleSeat(ILuaVM vm, LuaRef selfRef)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Character");
