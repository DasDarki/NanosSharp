...
public class Player : Entity
{
    ...
    public static void SetVOIPChannel(ILuaVM vm, LuaRef selfRef, LuaRef channel)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Player");
    ...
    public static LuaRef GetPing(ILuaVM vm, LuaRef selfRef)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Player");
    ...
    public static LuaRef GetVOIPChannel(ILuaVM vm, LuaRef selfRef)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "Player");
