...
public class VehicleWheeled : Paintable
{
    ...
    public static void SetEngineSetup(ILuaVM vm, LuaRef selfRef, LuaRef? max_torque = null, LuaRef? max_rpm = null, LuaRef? idle_rpm = null, LuaRef? brake_effect = null, LuaRef? rev_up_moi = null, LuaRef? rev_down_rate = null)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "VehicleWheeled");
    ...
    public static void SetAerodynamicsSetup(ILuaVM vm, LuaRef selfRef, LuaRef? mass = null, LuaRef? drag_coefficient = null, LuaRef? vehicle_chassis_width = null, LuaRef? vehicle_chassis_height = null, LuaRef? vehicle_downforce_coefficient = null, LuaRef? center_of_mass_override = null)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "VehicleWheeled");
    ...
    public static void SetTransmissionSetup(ILuaVM vm, LuaRef selfRef, LuaRef? transmission_final_ratio = null, LuaRef? transmission_change_up_rpm = null, LuaRef? transmission_change_down_rpm = null, LuaRef? transmission_gear_change_time = null, LuaRef? transmission_efficiency = null)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "VehicleWheeled");
    ...
    public static void SetSteeringWheelSetup(ILuaVM vm, LuaRef selfRef, LuaRef location, LuaRef radius)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "VehicleWheeled");
    ...
    public static void SetTireFlat(ILuaVM vm, LuaRef selfRef, LuaRef wheel_index, bool is_flat)
    {
        int pc = 0;
        vm.PushGlobalTable();
        vm.GetField(-1, "VehicleWheeled");
